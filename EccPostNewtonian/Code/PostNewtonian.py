...
def PNWaveform(q,omega_0,chi1_0,chi2_0,e_0=0.001,xi_0=0.0,frame_0=np.array([1.0,0.0,0.0,0.0]),t_0=0.0, omega_start=None, omega_end=None,t_PNStart=False, t_PNEnd=False, datatype="h", frametype="inertial", return_chi=False, PNEvolutionOrder=6.0, PNWaveformModeOrder=6.0, TaylorTn='TaylorT1', StepsPerOrbit=None, dt=None, ell_max = 8, tol=1e-10, MinStep=1e-7):
    """
