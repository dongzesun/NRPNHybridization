...
ConsSpec=[('wHat', float64[:]),('xHat', float64[:]),('yHat', float64[:]),('zHat', float64[:]),('M1', float64[:]),('M2', float64[:]),('e_i', float64[:]),('xi_i', float64[:]),('v_i', float64[:]),('S_chi1', float64[:]),('S_chi2', float64[:]),('M', float64[:]),('delta', float64[:]),('nu', float64[:]),('chi1chi1', float64[:]),('chi1chi2', float64[:]),('chi2chi2', float64[:]),('Fcal_0', float64[:]),('Fcal_2', float64[:]),('Fcal_3', float64[:]),('Fcal_4', float64[:]),('Fcal_5', float64[:]),('Fcal_6', float64[:]),('Fcal_lnv_6', float64[:]),('Fcal_7', float64[:]),('Fcal_8', float64[:]),('Fcal_lnv_8', float64[:]),('Fcal_9', float64[:]),('Fcal_lnv_9', float64[:]),('Fcal_10', float64[:]),('Fcal_lnv_10', float64[:]),('Fcal_11', float64[:]),('Fcal_lnv_11', float64[:]),('Fcal_12', float64[:]),('Fcal_lnv_12', float64[:]),('Fcal_lnv2_12', float64[:]),('Fecc_0', float64[:]),('Fecc_2', float64[:]),('E_0', float64[:]),('E_2', float64[:]),('E_4', float64[:]),('E_6', float64[:]),('E_8', float64[:]),('E_lnv_8', float64[:]),('E_10', float64[:]),('E_lnv_10', float64[:]),('E_11', float64[:]),('E_12', float64[:]),('E_lnv_12', float64[:]),('Eecc_2', float64[:]),('EvolveSpin1',boolean),('EvolveSpin2',boolean)]
@jitclass(ConsSpec)
class Cons:
    def __init__(self,wHat,xHat,yHat,zHat,M1,M2,e_i,xi_i,v_i,S_chi1,S_chi2,M,delta,nu,chi1chi1,chi1chi2,chi2chi2,Fcal_0,Fcal_2,Fcal_3,Fcal_4,Fcal_5,Fcal_6,Fcal_lnv_6,Fcal_7,Fcal_8,Fcal_lnv_8,Fcal_9,Fcal_lnv_9,Fcal_10,Fcal_lnv_10,Fcal_11,Fcal_lnv_11,Fcal_12,Fcal_lnv_12,Fcal_lnv2_12,Fecc_0,Fecc_2,E_0,E_2,E_4,E_6,E_8,E_lnv_8,E_10,E_lnv_10,E_11,E_12,E_lnv_12,Eecc_2,EvolveSpin1,EvolveSpin2):
        self.wHat=wHat
        self.xHat=xHat
        self.yHat=yHat
        self.zHat=zHat
...
def Recalculate_0(Cons,Vars,y):
    ...
    Vars.kappa_p = Vars.kappa_1 + Vars.kappa_2
    Vars.kappa_m = Vars.kappa_1 - Vars.kappa_2
...
def OmegaVec_chiVec_1_2p0(Cons,Vars):
    Omega1_coeff = Vars.v**5/Cons.M
    return Omega1_coeff*(Vars.S2*Vars.v**3*((2.0 - 0.5*Cons.delta)/Cons.M**2 + Vars.v*(-5.0*Vars.S_ell - 3.0*Vars.Sigma_ell*Cons.delta/Cons.M)/Cons.M**4) + Vars.ellHat*(-0.75*Cons.delta + 0.5*Cons.nu + Vars.v**2*(Cons.delta*(0.625*Cons.nu - 0.5625) + Cons.nu*(1.25 - 0.0416666666666667*Cons.nu) + Vars.v*(Vars.v*(Cons.nu*(Cons.nu*(0.229166666666667*Cons.nu - 4.94791666666667) + 2.89583333333333) + 0.96875 + (Cons.delta*(Cons.nu*(5.91666666666667 - 0.489583333333333*Cons.nu) - 0.96875) + (Vars.S_ell*(Vars.S_ell*(Vars.kappa_p*(-0.25*Cons.nu - 0.375) - 0.5*Cons.nu - 0.75) + Vars.Sigma_ell*(Cons.delta*(Vars.kappa_p*(-0.25*Cons.nu - 0.375) - 0.5*Cons.nu - 0.75) + Vars.kappa_m*(0.25*Cons.nu + 0.375))) + Vars.Sigma_ell**2*(Cons.delta*Vars.kappa_m*(0.125*Cons.nu + 0.1875) + Vars.kappa_p*(Cons.nu*(0.25*Cons.nu + 0.25) - 0.1875) + Cons.nu*(0.5*Cons.nu + 0.75)) + (Vars.S_ell*(Vars.S_ell*Cons.delta*(0.375*Vars.kappa_p + 0.75) + Vars.Sigma_ell*Cons.delta*(Cons.delta*(0.375*Vars.kappa_p + 0.75) - 0.375*Vars.kappa_m)) + Vars.Sigma_ell**2*Cons.delta*(-0.1875*Cons.delta*Vars.kappa_m + Vars.kappa_p*(0.1875 - 0.375*Cons.nu) - 0.75*Cons.nu))/Cons.M)/Cons.M**7)/Cons.M) + (Vars.S_ell*(0.833333333333333*Cons.nu + 1.25) + (-1.25*Vars.S_ell*Cons.delta + Vars.Sigma_ell*Cons.delta*(0.5*Cons.nu + 0.75) - 0.75*Vars.Sigma_ell*Cons.delta**2/Cons.M)/Cons.M)/Cons.M**2) + 0.5625) + 0.75) + Vars.lambdaHat*Vars.v**3*(Vars.S2_lambda*(0.5*Cons.delta + 2.0)/Cons.M**2 + Vars.v*(Vars.S1_lambda*(-0.75*Cons.delta - 3.0*Vars.kappa_1 + 2.25) + Vars.S1_lambda*(Cons.delta*(0.75 - 1.5*Vars.kappa_1) + 1.5*Vars.kappa_1 - 0.75)/Cons.nu)/Cons.M**2) + Vars.nHat*Vars.v*(3.0*Vars.chi1_n*Cons.nu + Vars.v**2*((Vars.S1_n*(Cons.delta*(-2.25*Vars.kappa_1 - 0.25) + Vars.kappa_1*(1.5*Cons.nu + 0.75) + 0.5*Cons.nu + 3.25) + Vars.S1_n*(Cons.delta*(1.5 - 0.75*Vars.kappa_1) + 0.75*Vars.kappa_1 - 1.5)/Cons.nu + Vars.S2_n*(1.5*Cons.delta - 1.0*Cons.nu + 3.0))/Cons.M**2 + Vars.v*(-15.0*Vars.S1_n*Vars.S_ell*Vars.kappa_1 + Vars.S1_n*Vars.S_ell*(-7.5*Cons.delta*Vars.kappa_1 + 7.5*Vars.kappa_1)/Cons.nu + 15.0*Vars.S2_n*Vars.S_ell + (-9.0*Vars.S1_n*Vars.Sigma_ell*Cons.delta*Vars.kappa_1 + Vars.S1_n*Vars.Sigma_ell*Cons.delta*(-4.5*Cons.delta*Vars.kappa_1 + 4.5*Vars.kappa_1)/Cons.nu + 9.0*Vars.S2_n*Vars.Sigma_ell*Cons.delta)/Cons.M)/Cons.M**4) + 3.0*Cons.M2**2*Vars.chi2_n/Cons.M**2) - Cons.M2**2*Vars.chiVec2*Vars.v/Cons.M**2)

@njit
def OmegaVec_chiVec_2_2p0(Cons,Vars):
    Omega2_coeff = Vars.v**5/Cons.M
    return Omega2_coeff*(Vars.S1*Vars.v**3*((0.5*Cons.delta + 2.0)/Cons.M**2 + Vars.v*(-5.0*Vars.S_ell + 3.0*Vars.Sigma_ell*Cons.delta/Cons.M)/Cons.M**4) + Vars.ellHat*(0.75*Cons.delta + 0.5*Cons.nu + Vars.v**2*(Cons.delta*(0.5625 - 0.625*Cons.nu) + Cons.nu*(1.25 - 0.0416666666666667*Cons.nu) + Vars.v*(Vars.v*(Cons.nu*(Cons.nu*(0.229166666666667*Cons.nu - 4.94791666666667) + 2.89583333333333) + 0.96875 + (Cons.delta*(Cons.nu*(0.489583333333333*Cons.nu - 5.91666666666667) + 0.96875) + (Vars.S_ell*(Vars.S_ell*(Vars.kappa_p*(-0.25*Cons.nu - 0.375) - 0.5*Cons.nu - 0.75) + Vars.Sigma_ell*(Cons.delta*(Vars.kappa_p*(0.25*Cons.nu + 0.375) + 0.5*Cons.nu + 0.75) + Vars.kappa_m*(-0.25*Cons.nu - 0.375))) + Vars.Sigma_ell**2*(Cons.delta*Vars.kappa_m*(0.125*Cons.nu + 0.1875) + Vars.kappa_p*(Cons.nu*(0.25*Cons.nu + 0.25) - 0.1875) + Cons.nu*(0.5*Cons.nu + 0.75)) + (Vars.S_ell*(Vars.S_ell*Cons.delta*(-0.375*Vars.kappa_p - 0.75) + Vars.Sigma_ell*Cons.delta*(Cons.delta*(0.375*Vars.kappa_p + 0.75) - 0.375*Vars.kappa_m)) + Vars.Sigma_ell**2*Cons.delta*(0.1875*Cons.delta*Vars.kappa_m + Vars.kappa_p*(0.375*Cons.nu - 0.1875) + 0.75*Cons.nu))/Cons.M)/Cons.M**7)/Cons.M) + (Vars.S_ell*(0.833333333333333*Cons.nu + 1.25) + (1.25*Vars.S_ell*Cons.delta + Vars.Sigma_ell*Cons.delta*(-0.5*Cons.nu - 0.75) - 0.75*Vars.Sigma_ell*Cons.delta**2/Cons.M)/Cons.M)/Cons.M**2) + 0.5625) + 0.75) + Vars.lambdaHat*Vars.v**3*(Vars.S1_lambda*(2.0 - 0.5*Cons.delta)/Cons.M**2 + Vars.v*(Vars.S2_lambda*(0.75*Cons.delta - 3.0*Vars.kappa_2 + 2.25) + Vars.S2_lambda*(Cons.delta*(1.5*Vars.kappa_2 - 0.75) + 1.5*Vars.kappa_2 - 0.75)/Cons.nu)/Cons.M**2) + Vars.nHat*Vars.v*(3.0*Vars.chi2_n*Cons.nu + Vars.v**2*((Vars.S1_n*(-1.5*Cons.delta - 1.0*Cons.nu + 3.0) + Vars.S2_n*(Cons.delta*(2.25*Vars.kappa_2 + 0.25) + Vars.kappa_2*(1.5*Cons.nu + 0.75) + 0.5*Cons.nu + 3.25) + Vars.S2_n*(Cons.delta*(0.75*Vars.kappa_2 - 1.5) + 0.75*Vars.kappa_2 - 1.5)/Cons.nu)/Cons.M**2 + Vars.v*(15.0*Vars.S1_n*Vars.S_ell - 15.0*Vars.S2_n*Vars.S_ell*Vars.kappa_2 + Vars.S2_n*Vars.S_ell*(7.5*Cons.delta*Vars.kappa_2 + 7.5*Vars.kappa_2)/Cons.nu + (-9.0*Vars.S1_n*Vars.Sigma_ell*Cons.delta + 9.0*Vars.S2_n*Vars.Sigma_ell*Cons.delta*Vars.kappa_2 + Vars.S2_n*Vars.Sigma_ell*Cons.delta*(-4.5*Cons.delta*Vars.kappa_2 - 4.5*Vars.kappa_2)/Cons.nu)/Cons.M)/Cons.M**4) + 3.0*Cons.M1**2*Vars.chi1_n/Cons.M**2) - Cons.M1**2*Vars.chiVec1*Vars.v/Cons.M**2)

@njit
def OmegaVec_2p0(Cons,Vars):
    gamma_PN_4 = -5.41666666666667*Cons.nu + 1.0 + (Vars.S_ell**2*(-0.5*Vars.kappa_p - 1.0) + Vars.S_ell*Vars.Sigma_ell*(-0.5*Cons.delta*Vars.kappa_p - Cons.delta + 0.5*Vars.kappa_m) + Vars.Sigma_ell**2*(0.25*Cons.delta*Vars.kappa_m - 0.25*Vars.kappa_p + Cons.nu*(0.5*Vars.kappa_p + 1.0)))/Cons.M**8
    a_ell_0 = 7.0*Vars.S_n + 3.0*Vars.Sigma_n*Cons.delta
...
def Recalculate_3p0(Cons,Vars,y):
    ...
    Vars.Fcal_coeff = 32*Cons.nu**2*Vars.v**10/5
    Vars.Fcal_SQ_4 = Cons.chi1chi1*(-89*Cons.delta/192 + 89*Cons.nu/96 - 89/192) - 103*Cons.chi1chi2*Cons.nu/48 + Cons.chi2chi2*(89*Cons.delta/192 + 89*Cons.nu/96 - 89/192) + Vars.chi_a_ell*(Vars.chi_a_ell*(287/96 - 12*Cons.nu) + 287*Vars.chi_s_ell*Cons.delta/48) + Vars.chi_s_ell**2*(Cons.nu/24 + 287/96)
    Vars.Fcal_SQ_6 = Cons.nu*(-0.0714285714285714*Cons.delta*(233*Vars.SSigma + 226*Vars.S_lambda*Vars.Sigma_lambda - 925*Vars.S_n*Vars.Sigma_n)/Cons.M**4 - 0.00297619047619048*(2796*Vars.SS*Vars.kappa_p + 5592*Vars.SS + 2796*Vars.SSigma*Cons.delta*Vars.kappa_p + 106632*Vars.SSigma*Vars.kappa_m + 2712*Vars.S_lambda**2*(Vars.kappa_p + 2) + 2712*Vars.S_lambda*Vars.Sigma_lambda*(Cons.delta*Vars.kappa_p + 70*Vars.kappa_m) - 11100*Vars.S_n**2*(Vars.kappa_p + 2) - 12*Vars.S_n*Vars.Sigma_n*(925*Cons.delta*Vars.kappa_p + 42478*Vars.kappa_m) + 25959*Vars.SigmaSigma*Cons.delta*Vars.kappa_m - 264033*Vars.SigmaSigma*Vars.kappa_p - 563186*Vars.SigmaSigma + 46782*Vars.Sigma_lambda**2*Cons.delta*Vars.kappa_m - 245904*Vars.Sigma_lambda**2*Vars.kappa_p - 101816*Vars.Sigma_lambda**2 - 124659*Vars.Sigma_n**2*Cons.delta*Vars.kappa_m + 1038003*Vars.Sigma_n**2*Vars.kappa_p + 1890564*Vars.Sigma_n**2)/Cons.M**4) - 0.00595238095238095*Cons.delta*(244151*Vars.SSigma + 96043*Vars.S_lambda*Vars.Sigma_lambda - 937059*Vars.S_n*Vars.Sigma_n)/Cons.M**4 + 0.0357142857142857*Cons.nu**2*(Vars.kappa_p + 2)*(233*Vars.SigmaSigma + 226*Vars.Sigma_lambda**2 - 925*Vars.Sigma_n**2)/Cons.M**4 + 0.00297619047619048*(27357*Vars.SS*Cons.delta*Vars.kappa_m - 210717*Vars.SS*Vars.kappa_p - 414138*Vars.SS - 238074*Vars.SSigma*Cons.delta*Vars.kappa_p + 238074*Vars.SSigma*Vars.kappa_m + Vars.S_lambda**2*(48138*Cons.delta*Vars.kappa_m - 150984*Vars.kappa_p - 283211) - 199122*Vars.S_lambda*Vars.Sigma_lambda*(Cons.delta*Vars.kappa_p - Vars.kappa_m) + Vars.S_n**2*(-130209*Cons.delta*Vars.kappa_m + 783135*Vars.kappa_p + 1863459) + 913344*Vars.S_n*Vars.Sigma_n*(Cons.delta*Vars.kappa_p - Vars.kappa_m) + 119037*Vars.SigmaSigma*Cons.delta*Vars.kappa_m - 119037*Vars.SigmaSigma*Vars.kappa_p - 44008*Vars.SigmaSigma + 99561*Vars.Sigma_lambda**2*Cons.delta*Vars.kappa_m - 99561*Vars.Sigma_lambda**2*Vars.kappa_p + 49153*Vars.Sigma_lambda**2 - 456672*Vars.Sigma_n**2*Cons.delta*Vars.kappa_m + 456672*Vars.Sigma_n**2*Vars.kappa_p + 103227*Vars.Sigma_n**2)/Cons.M**4
    Vars.Fcal_SO_3 = (-4*Vars.S_ell - 5*Vars.Sigma_ell*Cons.delta/4)/Cons.M**2
    Vars.Fcal_SO_5 = (Vars.S_ell*(272*Cons.nu/9 - 9/2) + Vars.Sigma_ell*Cons.delta*(43*Cons.nu/4 - 13/16))/Cons.M**2
    Vars.Fcal_SO_6 = (-16*Vars.S_ell*pi - 31*Vars.Sigma_ell*Cons.delta*pi/6)/Cons.M**2
    Vars.Fecc_coeff = 157*Cons.e_i**2.0*Cons.v_i**6.33333333333333/(24*Vars.v**6.33333333333333)
    Vars.E_SQ_4 = -3*Vars.chi_a_ell**2/2 - 3*Vars.chi_s_ell**2/2 - Cons.delta*(Cons.chi2chi2/2 + 3*Vars.chi_a_ell*Vars.chi_s_ell) + Cons.nu*(Cons.chi1chi2 + 6*Vars.chi_a_ell**2) + (Cons.chi1chi1 + Cons.chi2chi2)*(Cons.delta - 2*Cons.nu + 1)/4
    Vars.E_SQ_6 = Cons.nu*(-3*Cons.delta*(Vars.SSigma - 3*Vars.S_n*Vars.Sigma_n)/Cons.M**4 + 0.25*(-6*Vars.SS*Vars.kappa_p - 12*Vars.SS - 6*Vars.SSigma*Cons.delta*Vars.kappa_p - 26*Vars.SSigma*Vars.kappa_m + 24*Vars.S_lambda*Vars.Sigma_lambda*Vars.kappa_m + 18*Vars.S_n**2*(Vars.kappa_p + 2) + 18*Vars.S_n*Vars.Sigma_n*(Cons.delta*Vars.kappa_p + 3*Vars.kappa_m) + 19*Vars.SigmaSigma*Vars.kappa_p - 80*Vars.SigmaSigma - 18*Vars.Sigma_lambda**2*Vars.kappa_p + 76*Vars.Sigma_lambda**2 - 39*Vars.Sigma_n**2*Vars.kappa_p + 168*Vars.Sigma_n**2 + Cons.delta*Vars.kappa_m*(-5*Vars.SigmaSigma + 6*Vars.Sigma_lambda**2 + 9*Vars.Sigma_n**2))/Cons.M**4) + Cons.delta*(15*Vars.SSigma - 13*Vars.S_lambda*Vars.Sigma_lambda - 29*Vars.S_n*Vars.Sigma_n)/Cons.M**4 + 1.5*Cons.nu**2*(Vars.SigmaSigma - 3*Vars.Sigma_n**2)*(Vars.kappa_p + 2)/Cons.M**4 + 0.25*(8*Vars.SS*Cons.delta*Vars.kappa_m - 6*Vars.SS*Vars.kappa_p + 36*Vars.SS - 14*Vars.SSigma*Cons.delta*Vars.kappa_p + 14*Vars.SSigma*Vars.kappa_m + Vars.S_lambda**2*(-6*Cons.delta*Vars.kappa_m + 6*Vars.kappa_p - 28) + 12*Vars.S_lambda*Vars.Sigma_lambda*(Cons.delta*Vars.kappa_p - Vars.kappa_m) - 6*Vars.S_n**2*(3*Cons.delta*Vars.kappa_m - 2*Vars.kappa_p + 10) + 30*Vars.S_n*Vars.Sigma_n*(Cons.delta*Vars.kappa_p - Vars.kappa_m) + 7*Vars.SigmaSigma*Cons.delta*Vars.kappa_m - 7*Vars.SigmaSigma*Vars.kappa_p + 24*Vars.SigmaSigma - 6*Vars.Sigma_lambda**2*Cons.delta*Vars.kappa_m + 6*Vars.Sigma_lambda**2*Vars.kappa_p - 24*Vars.Sigma_lambda**2 - 15*Vars.Sigma_n**2*Cons.delta*Vars.kappa_m + 15*Vars.Sigma_n**2*Vars.kappa_p - 48*Vars.Sigma_n**2)/Cons.M**4
    Vars.E_SO_3 = (14*Vars.S_ell/3 + 2*Vars.Sigma_ell*Cons.delta)/Cons.M**2
    Vars.E_SO_5 = (Vars.S_ell*(11 - 61*Cons.nu/9) + Vars.Sigma_ell*Cons.delta*(3 - 10*Cons.nu/3))/Cons.M**2
...
def TaylorT1_3p0(Cons,Vars):
    Flux = Vars.Fcal_coeff*Vars.Fecc_coeff*(Cons.Fecc_0 + Cons.Fecc_2*Vars.v**2) + Vars.Fcal_coeff*(Cons.Fcal_0 + Vars.v**2*(Cons.Fcal_2 + Vars.v*(Cons.Fcal_3 + Vars.Fcal_SO_3 + Vars.v*(Cons.Fcal_4 + Vars.Fcal_SQ_4 + Vars.v*(Cons.Fcal_5 + Vars.Fcal_SO_5 + Vars.v*(Cons.Fcal_6 + Vars.Fcal_SO_6 + Vars.Fcal_SQ_6 + Cons.Fcal_lnv_6*Vars.logv))))))
    dEdV = 1.16666666666667*Cons.Eecc_2*Cons.M*Cons.e_i**2.0*Cons.nu*Vars.v**(-3.33333333333333)*Cons.v_i**6.33333333333333 - 0.5*Cons.M*Cons.nu*Vars.v*(2.0*Cons.E_0 + Vars.v**2*(4.0*Cons.E_2 + Vars.v*(5.0*Vars.E_SO_3 + Vars.v*(6.0*Cons.E_4 + 6.0*Vars.E_SQ_4 + Vars.v*(7.0*Vars.E_SO_5 + 8.0*Vars.v*(Cons.E_6 + Vars.E_SQ_6))))))
    Absorption = 0
    dvdt_T1 = (-Absorption - Flux)/dEdV
    dydt=np.zeros(10)
...
def TaylorT1_4p0(Cons,Vars):
    ...
    dEdV = 1.16666666666667*Cons.Eecc_2*Cons.M*Cons.e_i**2.0*Cons.nu*Vars.v**(-3.33333333333333)*Cons.v_i**6.33333333333333 - 0.5*Cons.M*Cons.nu*Vars.v*(2.0*Cons.E_0 + Vars.v**2*(4.0*Cons.E_2 + Vars.v*(5.0*Vars.E_SO_3 + Vars.v*(6.0*Cons.E_4 + 6.0*Vars.E_SQ_4 + Vars.v*(7.0*Vars.E_SO_5 + Vars.v*(8.0*Cons.E_6 + 8.0*Vars.E_SQ_6 + Vars.v*(9.0*Vars.E_SO_7 + Vars.v*(10.0*Cons.E_8 + Cons.E_lnv_8*(10.0*Vars.logv + 1.0)))))))))
    Absorption = 0
    dvdt_T1 = (-Absorption - Flux)/dEdV
    dydt=np.zeros(10)
...
class PNEv:
    ...
    def Evolution(wHat_i, xHat_i, yHat_i, zHat_i, M1_i, M2_i, e_i, xi_i, v_i, S_chi1_i, S_chi2_i, R_i,
        ...
        z=np.array([0.0])
        PNEv.Cons=Cons(z,z,z,z,z,z,z,z,z,z,z,z,z,z,z,z,z,z,z,z,z,z,z,z,z,z,z,z,z,z,z,z,z,z,z,z,z,z,z,z,z,z,z,z,z,z,z,z,z,z,True,True)
        PNEv.Vars=Vars(z,z,z,z,z,z,z,z,z,z,z,z,z,z,z,z,z,z,z,z,z,z,z,z,z,z,z,z,z,z,z,z,z,z,z,z,z,z,z,z,z,z,z,z,z,z,z,z,z,z,z,z,z,z,z,z,z)
