...
class WaveformModes_0PN :
    def WaveformModes_0PN(xHat_i, yHat_i, zHat_i, M1_i, M2_i, v_i, S_chi1_i, S_chi2_i, rfrak_chi1_x_i, rfrak_chi1_y_i, rfrak_chi2_x_i,
           rfrak_chi2_y_i, rfrak_frame_x_i, rfrak_frame_y_i, rfrak_frame_z_i,y) :            
...
class WaveformModes_0p50PN :
    def WaveformModes_0p50PN(xHat_i, yHat_i, zHat_i, M1_i, M2_i, v_i, S_chi1_i, S_chi2_i, rfrak_chi1_x_i, rfrak_chi1_y_i, rfrak_chi2_x_i,
           rfrak_chi2_y_i, rfrak_frame_x_i, rfrak_frame_y_i, rfrak_frame_z_i,y) :            
        ModeData=np.empty((len(y[0]),77), dtype=complex)
        def WaveformModes(M1_i, M2_i, v_i):
            I=1j
...
class WaveformModes_1p0PN :
    def WaveformModes_1p0PN(xHat_i, yHat_i, zHat_i, M1_i, M2_i, v_i, S_chi1_i, S_chi2_i, rfrak_chi1_x_i, rfrak_chi1_y_i, rfrak_chi2_x_i,
           rfrak_chi2_y_i, rfrak_frame_x_i, rfrak_frame_y_i, rfrak_frame_z_i,y) :            
        ModeData=np.empty((len(y[0]),77), dtype=complex)
        def WaveformModes(xHat_i, yHat_i, zHat_i, M1_i, M2_i, v_i, S_chi1_i, rfrak_chi1_x_i, rfrak_chi1_y_i, chiVec1_i,
                      chiVec2_i):
            I=1j
            global R_S1
            global chi1_n
        ...
        for i in range(len(y[0])):
            ...
            chiVec1_i=quaternion.as_float_array(chiVec1)
            chiVec2_i=quaternion.as_float_array(chiVec2)
            ModeData[i,:]=WaveformModes(xHat_i, yHat_i, zHat_i, M1_i, M2_i, v_i, S_chi1_i, rfrak_chi1_x_i, rfrak_chi1_y_i, chiVec1_i,
                      chiVec2_i)
        return ModeData

class WaveformModes_1p5PN :
    def WaveformModes_1p5PN(xHat_i, yHat_i, zHat_i, M1_i, M2_i, v_i, S_chi1_i, S_chi2_i, rfrak_chi1_x_i, rfrak_chi1_y_i, rfrak_chi2_x_i,
           rfrak_chi2_y_i, rfrak_frame_x_i, rfrak_frame_y_i, rfrak_frame_z_i,y) :            
        ModeData=np.empty((len(y[0]),77), dtype=complex)
        def WaveformModes(xHat_i, yHat_i, zHat_i, M1_i, M2_i, v_i, S_chi1_i, rfrak_chi1_x_i, rfrak_chi1_y_i, chiVec1_i,
                      chiVec2_i):
...
class WaveformModes_2p0PN :
    def WaveformModes_2p0PN(xHat_i, yHat_i, zHat_i, M1_i, M2_i, v_i, S_chi1_i, S_chi2_i, rfrak_chi1_x_i, rfrak_chi1_y_i, rfrak_chi2_x_i,
           rfrak_chi2_y_i, rfrak_frame_x_i, rfrak_frame_y_i, rfrak_frame_z_i,y) :            
        ModeData=np.empty((len(y[0]),77), dtype=complex)
        def WaveformModes(xHat_i, yHat_i, zHat_i, M1_i, M2_i, v_i, S_chi1_i, rfrak_chi1_x_i, rfrak_chi1_y_i, chiVec1_i,
                      chiVec2_i):
...
class WaveformModes_2p5PN :
    def WaveformModes_2p5PN(xHat_i, yHat_i, zHat_i, M1_i, M2_i, v_i, S_chi1_i, S_chi2_i, rfrak_chi1_x_i, rfrak_chi1_y_i, rfrak_chi2_x_i,
           rfrak_chi2_y_i, rfrak_frame_x_i, rfrak_frame_y_i, rfrak_frame_z_i,y) :            
        ModeData=np.empty((len(y[0]),77), dtype=complex)
        def WaveformModes(xHat_i, yHat_i, zHat_i, M1_i, M2_i, v_i, S_chi1_i, rfrak_chi1_x_i, rfrak_chi1_y_i, chiVec1_i,
                      chiVec2_i):
...
class WaveformModes_3p0PN :
    def WaveformModes_3p0PN(xHat_i, yHat_i, zHat_i, M1_i, M2_i, v_i, S_chi1_i, S_chi2_i, rfrak_chi1_x_i, rfrak_chi1_y_i, rfrak_chi2_x_i,
           rfrak_chi2_y_i, rfrak_frame_x_i, rfrak_frame_y_i, rfrak_frame_z_i,y) :            
        ModeData=np.empty((len(y[0]),77), dtype=complex)
        def WaveformModes(xHat_i, yHat_i, zHat_i, M1_i, M2_i, v_i, S_chi1_i, rfrak_chi1_x_i, rfrak_chi1_y_i, chiVec1_i,
                      chiVec2_i):
...
class WaveformModes_3p5PN :
    def WaveformModes_3p5PN(xHat_i, yHat_i, zHat_i, M1_i, M2_i, v_i, S_chi1_i, S_chi2_i, rfrak_chi1_x_i, rfrak_chi1_y_i, rfrak_chi2_x_i,
           rfrak_chi2_y_i, rfrak_frame_x_i, rfrak_frame_y_i, rfrak_frame_z_i,y) :            
        ModeData=np.empty((len(y[0]),77), dtype=complex)
        def WaveformModes(xHat_i, yHat_i, zHat_i, M1_i, M2_i, v_i, S_chi1_i, rfrak_chi1_x_i, rfrak_chi1_y_i, chiVec1_i,
                      chiVec2_i):
